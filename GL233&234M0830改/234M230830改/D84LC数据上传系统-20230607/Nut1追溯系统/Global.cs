...
namespace 卓汇数据追溯系统
{
    public class Global
    {
        ...
        #region OEE参数
        public static short OEE_Code = 1;//上笔状态 1#

        public static short OEE_CodeB = 1;//上笔状态 2#

        public static short OEE_CodeC = 1;//上笔状态 3#

        public static string start_time = string.Empty;//每笔状态的开始时间

        public static string start_timeB = string.Empty;//每笔状态的开始时间

        public static string start_timeC = string.Empty;//每笔状态的开始时间
        #endregion
        ...
        //public static string Trace_line_id = "C12-3FA-01";//机台line_id
        //public static string Trace_station_id = "IPGL_C12-3FA-01_3_STATION1661";//机台station_id
