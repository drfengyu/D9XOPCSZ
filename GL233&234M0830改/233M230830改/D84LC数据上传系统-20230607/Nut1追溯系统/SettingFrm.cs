    ...
    public partial class SettingFrm : Form
    {
        ...
        private void SettingFrm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                checkBoxLR.Checked = inidata.productconfig.OpenTimeLROpen == "1";
        ...
        private void btn_CommunicationSave_Click(object sender, EventArgs e)
        {
            ...
            if (checkBoxLR.Checked)
            {
                inidata.productconfig.OpenTimeLROpen = "1";
                Global.inidata.productconfig.OpenTimeLROpen = "1";
            }
            else
            {
                inidata.productconfig.OpenTimeLROpen = "2";
                Global.inidata.productconfig.OpenTimeLROpen = "2";
            }
