   ...
   public class OEEHelper
    {
        ...
        public void Restart() {
           ...
           Global._homefrm.AppendRichText(start_time + " -> " + t2.ToString("yyyy-MM-dd HH:mm:ss.fff") + "," + "软件关闭" + "," + ts + "分钟", "Rtxt_OEE_TimeSpan");
            ...
            catch (Exception EX)
            {
                ...
                Log.WriteLog_ServerInfo("OEE报警编号:"+Global.OEE_Code+","+Global.OEE_CodeB+","+Global.OEE_CodeC);
            }
        ...
        public void OEENG(string barcode,string leftRail,string RightRail,string msg,string Station,string Fixture="") {
            ...
            string message = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff") + "," + barcode + "," + leftRail + "," + RightRail + "," + Fixture+"," + Station + ":" + msg;
            Global._homefrm.AppendRichText(message, "richTextBoxNG");
            Log.WriteCSV(message, System.AppDomain.CurrentDomain.BaseDirectory + "\\NG明细\\");
        }
    }
}
