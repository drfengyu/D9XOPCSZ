       ...
       private static object _lock = new object();
        public void ProductTotal(object obj)
        {
            ...
            "MW34102", "MW34104", "MW34106", "MW35102", "MW35104", "MW35106"}, "下料产能统计", Global.plc1);
                ...
                {
                    Log.WriteLog_ServerInfo("产能存储异常:"+ex.Message); ;
                }
            }
        }
        ...
        //                    WriteCSV("合计," + Convert.ToDouble(TotalCountIOK.Content) + "," + Convert.ToDouble(TotalCountING.Content) + "," + Convert.ToDouble(TotalCountILV.Content) + "," + Convert.ToDouble(TotalTimeILV.Content), FileName);
        //                }
        //                else
        //                {
        //                    WriteCSV("合计," + Convert.ToDouble(TotalCountIOK.Content) + "," + Convert.ToDouble(TotalCountING.Content) + "," + Convert.ToDouble(TotalCountILV.Content), FileName);
        //                }
        ...
        //                    WriteCSV("合计," + Convert.ToDouble(TotalCountIOKN.Content) + "," + Convert.ToDouble(TotalCountINGN.Content) + "," + Convert.ToDouble(TotalCountILVN.Content) + "," + Convert.ToDouble(TotalTimeILVN.Content), FileName);
        //                }
        //                else
        //                {
        //                    WriteCSV("合计," + Convert.ToDouble(TotalCountIOKN.Content) + "," + Convert.ToDouble(TotalCountINGN.Content) + "," + Convert.ToDouble(TotalCountILVN.Content), FileName);
        //                }
        //            }
        //        }
            ...
            try
            {
                if (DateTime.Now.Hour >= 8 && DateTime.Now.Hour < 20)
                {
                    ...
                    if (DateTime.Now.Hour == 19)
                    {
                        ...
                        //TotalCountIOK
                        //OperateResult<float> TotalCountIOK = plc1.ReadFloat(a[10]);
                        int TotalCountIOK = convertInt32ToInt(plc1.ReadInt32(a[10]).Content);
                        ...
                        //TotalCountING
                        // OperateResult<float> TotalCountING = plc1.ReadFloat(a[11]);
                        int TotalCountING = convertInt32ToInt(plc1.ReadInt32(a[11]).Content);
                        //TotalCountILV
                        // OperateResult<float> TotalCountILV = plc1.ReadFloat(a[12]);
                        int TotalCountILV = convertInt32ToInt(plc1.ReadInt32(a[12]).Content);
                        if (FileName.Contains("时间统计"))
                        {
                            // OperateResult<float> TotalTimeILV = plc1.ReadFloat(a[16]);
                            int TotalTimeILV = convertInt32ToInt(plc1.ReadInt32(a[16]).Content);
                            WriteCSV("合计," + TotalCountIOK + "," + TotalCountING + "," + TotalCountILV + "," + TotalTimeILV, FileName);
                        }
                        else
                        {
                            WriteCSV("合计," + TotalCountIOK + "," + TotalCountING + "," + TotalCountILV, FileName);
                        }
                ...
                else
                {
                    ...
                    if (DateTime.Now.Hour == 7)
                    {
                        //TotalCountIOK
                        //OperateResult<float> TotalCountIOKN = plc1.ReadFloat(a[13]);
                        int TotalCountIOKN = convertInt32ToInt(plc1.ReadInt32(a[13]).Content);
                        //short TotalCountIOKN = 0;
                        //for (int i = 0; i < 12; i++)
                        //{
                        ...
                        //TotalCountING
                        //OperateResult<float> TotalCountINGN = plc1.ReadFloat(a[14]);
                        int TotalCountINGN = convertInt32ToInt(plc1.ReadInt32(a[14]).Content);
                        //TotalCountILV
                        //OperateResult<float> TotalCountILVN = plc1.ReadFloat(a[15]);
                        int TotalCountILVN = convertInt32ToInt(plc1.ReadInt32(a[15]).Content);
                        if (FileName.Contains("时间统计"))
                        {
                            //OperateResult<float> TotalTimeILVN = plc1.ReadFloat(a[17]);
                            int TotalTimeILVN = convertInt32ToInt(plc1.ReadInt32(a[17]).Content);
                            WriteCSV("合计," + TotalCountIOKN + "," + TotalCountINGN + "," + TotalCountILVN + "," + TotalTimeILVN, FileName);
                        }
                        else
                        {
                            WriteCSV("合计," + TotalCountIOKN + "," + TotalCountINGN + "," + TotalCountILVN, FileName);
                        }
                    }
                }
        ...
        private void WriteCSV(string text, string FileName)
        {
           ...
           string RootPath = System.AppDomain.CurrentDomain.BaseDirectory + "\\产能与时间统计\\" + time + "\\";
            ...
            string fileFullFileName = RootPath +Global.inidata.productconfig.productName+ time+FileName + ".csv";
