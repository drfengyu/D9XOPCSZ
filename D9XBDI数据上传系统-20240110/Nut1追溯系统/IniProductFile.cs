...
namespace 卓汇数据追溯系统
{
    public class ProductConfig
    {
        ...
        public string Trace_ip { set; get; }
        public string version { set; get; }
        public string Trace_line_id { set; get; }
        public string Trace_station_id { set; get; }
        public string productName { set; get; }//233M /234M
    ...
    public class IniProductFile
    {
        ...
        public void ReadProductConfigSection()
        {
            ...
            _productconfig.billNo = _iniOperation.ReadValue(sectionName, "billNo");
